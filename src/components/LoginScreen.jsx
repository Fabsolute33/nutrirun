...
import { PersonStanding, Mail, Lock, LogIn, UserPlus, AlertCircle, CheckCircle2 } from "lucide-react";
      ...
      <div style={{ width: "100%", maxWidth: 390, display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ textAlign: "center" }}>
          <div style={{
            ...
            marginBottom: 12, boxShadow: "0 4px 16px rgba(22,163,74,0.15)",
          }}>
            <PersonStanding size={40} color={C.accent} />
          </div>
